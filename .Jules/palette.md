...
## 2024-06-02 - Decorative Timeline Images
**Learning:** Timeline illustrations accompanied by descriptive titles cause redundant screen reader announcements if they have alt text.
**Action:** Treat timeline illustrations accompanied by descriptive titles as purely decorative by setting `alt=""` and `aria-hidden="true"` on the image to prevent redundant announcements.
