...
## 2026-05-10 - Redundant Alt Text in Timeline Patterns
**Learning:** Timeline illustrations directly accompanied by descriptive titles cause redundant and annoying screen reader announcements if given literal alt text.
**Action:** Treat such paired illustration/title elements as a single semantic group by setting `alt=""` and `aria-hidden="true"` on the purely decorative image.
