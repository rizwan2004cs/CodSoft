...
## 2024-05-18 - Calculator Accessibility
**Learning:** Mathematical symbols (+, -, *, /) and abbreviations (C, AC) can be ambiguous or mispronounced by screen readers if left as raw text.
**Action:** Always provide explicit `aria-label` attributes with descriptive text (e.g., "Add", "Subtract", "Clear", "All Clear") for operator buttons in interactive components to ensure accurate auditory feedback.